...
card_template_t display_minion_no_ability(std::string name,int cost,int attack,int defence,std::string desc) {
  return display_minion_general(CARD_TEMPLATE_MINION_NO_ABILITY,name,cost,attack,defence,desc,0);
}
